...
export default function Index({transactionHeader, transactionDetail, category}){
    // console.log(transactionDetail);
    // console.log(transactionHeader);
    const categoryIncome = transactionDetail.filter((item) => item.ms_category_id === 1);
    const categoryExpense = transactionDetail.filter((item) => item.ms_category_id === 2);
    ...
    const handleInputChange2 = (id, value, field) => {
        setFormInputs2(prevFormInputs => {
            return prevFormInputs.map(input =>
                input.id === id ? { ...input, [field]: value, category_id: selectedCategory2 } : input
            );
        });
    };
    ...
    const submitAll = () => {
        ...
        console.log('Selected Category ID1:', selectedCategory);
        console.log('Selected Category ID2:', selectedCategory2);

        // Inertia.post(route('admin.dashboard.store_data_transaksi'), {
        //     category_id: selectedCategory,
        //     category_id2: selectedCategory2,
        //     title: title,
                    ...
                    <div className="flex">
                        ...
                        <div className="w-1/2">
                            <TextArea
                                ...
                                className="w-full"
                                name="description"
                                value={transactionHeader.description}
                ...
                <div className="w-1/2">
                    ...
                    <div className="flex mt-4">
                        ...
                        <div className="w-1/2">
                            ...
                            className="w-full"
                            name="rate_euro"
                            value={transactionHeader.rate_euro}
                            onChange={(e) => handleTitleChange(e)}
                            />
                        </div>
                    </div>
                    <div className="flex mt-4">
                        ...
                        <div className="w-1/2">
                            ...
                            className="w-full"
                            name="date_paid"
                            value={transactionHeader.date_paid}
                            onChange={(e) => handleTitleChange(e)}
                            />
                        </div>
                    </div>
            ...
            <div className="border mt-4 pt-4">
                ...
                <div className="border p-7">
                    <div className="flex">
                        ...
                        <div className="w-5/6">
                            <select className="w-1/4" value={categoryIncome} onChange={handleCategoryChange}>
                                {category.map((item) => (
                            ...
                            {categoryIncome.map((input, index) => (
                ...
                <div className="border p-7">
                    <div className="flex">
                        ...
                        <div className="w-5/6">
                            ...
                            {categoryExpense.map((input, index) => (
                                <div key={input.id} className="flex mt-4">
                                    <div className="w-1/2">
                                    <TextInput
                                        type="text"
